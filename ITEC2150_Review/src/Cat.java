...
public class Cat extends Pet
{
	...
	public Cat(String type, String name, String ownerName, int age, boolean longHair, boolean clawed, String hairColor)
	{
	...
	{
		return super.toString() + " Cat [longHair=" + longHair + ", clawed=" + clawed + ", hairColor=" + hairColor
				+ "]";
	}

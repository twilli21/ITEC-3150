...
public class IntTree {
	...
	public void reverseInOrder() {
		IntTreeNode.clearCycleData();
		System.out.print("reverseInorder:");
		reverseInOrder(overallRoot);
		System.out.println();
	}
	
	private void reverseInOrder(IntTreeNode root)
	{
		if (root != null) {
			reverseInOrder(root.__gotoRight());
			System.out.print(" " + root.data);
			reverseInOrder(root.__gotoLeft());
		}
	}
	...
	private void preOrder(IntTreeNode root) {
		if (root != null) {
			System.out.print(" " + root.data);
			preOrder(root.__gotoLeft());
			preOrder(root.__gotoRight());
		}
	}
	...
	private void postOrder(IntTreeNode root) {
		if (root != null) {
			postOrder(root.__gotoLeft());
			postOrder(root.__gotoRight());
			System.out.print(" " + root.data);
		}
	}

...
{
	private SimpleBSTMapNode overallRoot;

	public TreePlotting(SimpleBSTMapNode root)
	{
		overallRoot = root;
	}
	...
	public String toString()
	{
		...
		// SimpleBSTMapNode.clearCycleData(20);
	...
	private String toString(SimpleBSTMapNode root, int sizeAboveLeft, int level, int size, int height, int width)
	{
	...
	private int __getSizeBetweenLeft(SimpleBSTMapNode root)
	{
	...
	private int __getSizeBetweenRight(SimpleBSTMapNode root)
	{
	...
	private int __getHeight(SimpleBSTMapNode root)
	{
		if (root == null)
		{
			return 0;
		...
		{
			int leftHeight = 0;
			SimpleBSTMapNode left = root.getLeft();
			if (left != null)
			{
				leftHeight = __getHeight(left);
			}
			int rightHeight = 0;
			SimpleBSTMapNode right = root.getRight();
			if (right != null)
			{
	...
	private int __getSize(SimpleBSTMapNode root)
	{
		if (root == null)
		{
			return 0;
	...
	private int __getWidest(SimpleBSTMapNode root)
	{
		if (root == null)
		{
			return 0;
